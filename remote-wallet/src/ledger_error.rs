...
pub enum LedgerError {
    #[error("X1 app not open on Ledger device")]
    ...
    #[error("Ledger received invalid X1 message")]
    ...
    #[error("X1 summary finalization failed on Ledger device")]
    SolanaSummaryFinalizeFailed = 0x6f00,

    #[error("X1 summary update failed on Ledger device")]
