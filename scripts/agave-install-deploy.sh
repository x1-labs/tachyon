...
case $TAG in
edge|beta)
  DOWNLOAD_URL=https://release.x1.xyz/"$TAG"/solana-release-$TARGET.tar.bz2
  ;;
*)
  DOWNLOAD_URL=https://github.com/x1-labs/tachyon/releases/download/"$TAG"/solana-release-$TARGET.tar.bz2
  ;;
esac
