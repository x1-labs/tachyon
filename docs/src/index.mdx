...
title: Home
sidebar_label: Home
pagination_label: Tachyon Validator Documentation Home
description: "Tachyon is a validator for the Solana blockchain maintained by the X1 Labs core engineering team \
  it is a fork of the original Solana validator software."
---

# Tachyon Validator Documentation
...
interoperable and decentralized. Tachyon is a fork of the original Solana validator
previously maintained by the Solana Labs team. Tachyon is now under active development by the
core engineering team at X1 Labs, one of several Solana validator clients.
...
Explore what it takes to operate an Tachyon validator and help secure the network.
