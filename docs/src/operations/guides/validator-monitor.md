...
The `x1 vote-account` command displays the recent voting activity from
your validator:

```bash
x1 vote-account ~/vote-account-keypair.json
```
...
```bash
# Similar to x1-gossip, you should see your validator in the list of cluster nodes
