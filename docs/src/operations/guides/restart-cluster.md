...
### Step 3. Optionally install the new x1 version
...
> b. Ask it over RPC what slot it's on: `x1 --url http://127.0.0.1:8899 slot`. It should return `SLOT_X` until we get to 80% stake
>
> Thanks!
